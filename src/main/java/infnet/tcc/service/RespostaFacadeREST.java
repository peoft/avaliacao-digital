...
@Stateless
@Path("/resposta/")
public class RespostaFacadeREST extends AbstractFacade<Resposta> {
    ...
    public void create(Resposta entity) {
        super.create(entity);
    }
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") PathSegment id, Resposta entity) {
        super.edit(entity);
    }
    ...
    @Path("{from}/{to}")
    @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public List<Resposta> findRange(@PathParam("from") Integer from, @PathParam("to") Integer to) {
